...
/*   Updated: 2023/02/24 14:03:35 by reben-ha         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_open_image(t_mlx_win *mlx_x)
{
	...
	mlx_x->img.start = mlx_xpm_file_to_image(mlx_x->mlx,
			"texture/start.xpm", &(mlx_x->width), &(mlx_x->height));
	ft_error_str(mlx_x->img.start, 1);
