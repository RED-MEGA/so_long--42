...
static void	open_image_exit(t_mlx_win *mlx_x)
{
	...
	mlx_x->img.exit_2 = mlx_xpm_file_to_image(mlx_x->mlx, "texture/door/exit_2.xpm", &(mlx_x->width), &(mlx_x->height));
	ft_error_str(mlx_x->img.exit_2, 1);
	mlx_x->img.exit_hole.frame_1 = mlx_xpm_file_to_image(mlx_x->mlx, "texture/door/fps/1.xpm", &(mlx_x->width), &(mlx_x->height));
	ft_error_str(mlx_x->img.exit_hole.frame_1, 1);
	mlx_x->img.exit_hole.frame_2 = mlx_xpm_file_to_image(mlx_x->mlx, "texture/door/fps/2.xpm", &(mlx_x->width), &(mlx_x->height));
	ft_error_str(mlx_x->img.exit_hole.frame_2, 1);
	mlx_x->img.exit_hole.frame_3 = mlx_xpm_file_to_image(mlx_x->mlx, "texture/door/fps/3.xpm", &(mlx_x->width), &(mlx_x->height));
	ft_error_str(mlx_x->img.exit_hole.frame_3, 1);
	mlx_x->img.exit_hole.frame_4 = mlx_xpm_file_to_image(mlx_x->mlx, "texture/door/fps/4.xpm", &(mlx_x->width), &(mlx_x->height));
	ft_error_str(mlx_x->img.exit_hole.frame_4, 1);
	mlx_x->img.exit_hole.frame_5 = mlx_xpm_file_to_image(mlx_x->mlx, "texture/door/fps/5.xpm", &(mlx_x->width), &(mlx_x->height));
	ft_error_str(mlx_x->img.exit_hole.frame_5, 1);
	mlx_x->img.exit_hole.frame_6 = mlx_xpm_file_to_image(mlx_x->mlx, "texture/door/fps/6.xpm", &(mlx_x->width), &(mlx_x->height));
	ft_error_str(mlx_x->img.exit_hole.frame_6, 1);
	mlx_x->img.exit_hole.frame_7 = mlx_xpm_file_to_image(mlx_x->mlx, "texture/door/fps/7.xpm", &(mlx_x->width), &(mlx_x->height));
	ft_error_str(mlx_x->img.exit_hole.frame_7, 1);
	mlx_x->img.exit_hole.frame_8 = mlx_xpm_file_to_image(mlx_x->mlx, "texture/door/fps/8.xpm", &(mlx_x->width), &(mlx_x->height));
	ft_error_str(mlx_x->img.exit_hole.frame_8, 1);
	mlx_x->img.exit_hole.frame_9 = mlx_xpm_file_to_image(mlx_x->mlx, "texture/door/fps/9.xpm", &(mlx_x->width), &(mlx_x->height));
	ft_error_str(mlx_x->img.exit_hole.frame_9, 1);
	mlx_x->img.exit_hole.frame_10 = mlx_xpm_file_to_image(mlx_x->mlx, "texture/door/fps/10.xpm", &(mlx_x->width), &(mlx_x->height));
...
void	ft_open_image(t_mlx_win *mlx_x)
{
	...
	mlx_x->img.enemy_angry = mlx_xpm_file_to_image(mlx_x->mlx, "texture/enemy_fight.xpm", &(mlx_x->width), &(mlx_x->height));
